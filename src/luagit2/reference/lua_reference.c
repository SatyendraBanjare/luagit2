...
int lua_git_reference_free (lua_State *L) {
	luagit2_reference *lua_ref = (luagit2_reference *)lua_touserdata(L, 1);
...
int lua_git_reference_iterator_free (lua_State *L) {
	luagit2_reference_iterator *lua_ref_iterator = (luagit2_reference_iterator *)lua_touserdata(L, 1);
