-- @module luagit2_libgit_test
local luagit2_libgit_tests = {}

function luagit2_libgit_tests.test_luagit2_version()	
...
function luagit2_libgit_tests.test_luagit2_GIT_OPT_GET_and_SET_MWINDOW_SIZE()	
...
function luagit2_libgit_tests.test_luagit2_GIT_OPT_GET_and_SET_MWINDOW_MAPPED_LIMIT()	
...
function luagit2_libgit_tests.test_luagit2_GIT_OPT_GET_and_SET_SEARCH_PATH()	
...
function luagit2_libgit_tests.test_luagit2_GIT_OPT_SET_CACHE_OBJECT_LIMIT()	
	lunatest.assert_true(lib.luagit2_SET_CACHE_OBJECT_LIMIT(123))
end

function luagit2_libgit_tests.test_luagit2_SET_CACHE_MAX_SIZE()	
	lunatest.assert_true(lib.luagit2_SET_CACHE_MAX_SIZE(123))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_CACHING()	
	lunatest.assert_true(lib.luagit2_ENABLE_CACHING(1))
end

function luagit2_libgit_tests.test_luagit2_GET_and_SET_TEMPLATE_PATH()	
...
function luagit2_libgit_tests.test_luagit2_SET_USER_AGENT()	
	lunatest.assert_true(lib.luagit2_SET_USER_AGENT("MY_USER_AGENT"))
end

function luagit2_libgit_tests.test_luagit2_SET_WINDOWS_SHAREMODE()	
	lunatest.assert_true(lib.luagit2_SET_WINDOWS_SHAREMODE(99999))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_STRICT_OBJECT_CREATION()	
	lunatest.assert_true(lib.luagit2_ENABLE_STRICT_OBJECT_CREATION(1))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_STRICT_SYMBOLIC_REF_CREATION()	
	lunatest.assert_true(lib.luagit2_ENABLE_STRICT_SYMBOLIC_REF_CREATION(1))
end

function luagit2_libgit_tests.test_luagit2_SET_SSL_CIPHERS()	
	lunatest.assert_true(lib.luagit2_SET_SSL_CIPHERS("Example_SSL_Cipher"))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_OFS_DELTA()	
	lunatest.assert_true(lib.luagit2_ENABLE_OFS_DELTA(1))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_FSYNC_GITDIR()	
	lunatest.assert_true(lib.luagit2_ENABLE_FSYNC_GITDIR(1))
end

function luagit2_libgit_tests.test_luagit2_ENABLE_STRICT_HASH_VERIFICATION()	
	lunatest.assert_true(lib.luagit2_ENABLE_STRICT_HASH_VERIFICATION(1))
end

return luagit2_libgit_tests